...
def api():
	...
	if len(resultarray) > result: # if result exists
		return render_template("api.html", status="OK", name=resultarray[result][0], players=resultarray[result][1], time=resultarray[result][2], age=resultarray[result][3], difficulty=resultarray[result][4], rank=resultarray[result][5], description=resultarray[result][6])
